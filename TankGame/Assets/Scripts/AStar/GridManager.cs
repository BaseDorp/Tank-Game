...
public class GridManager : MonoBehaviour
{
    ...
    void Awake()
    {
        //Get the list of obstacles objects tagged as "Wall"
    ...
    {
        width = numOfColumns * gridCellSize;
        height = numOfRows * gridCellSize;
    ...
    // Makes sure the the Row is not out of bounds
    int constrainRangeRow(int row)
    {
        if (row < 0)
        {
            return 0;
    ...
    // Makes sure the the Column is not out of bounds
    int ConstrainRangeColum(int colum)
    {
        if (colum < 0)
        {
            return 0;
    ...
    void AssignNeighbour(int row, int column, ArrayList neighbors)
    {
        ...
        {
            column = ConstrainRangeColum(column);
            //row = constrainRangeRow(row);
